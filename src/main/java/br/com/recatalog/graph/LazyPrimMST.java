...
public class LazyPrimMST {
    ...
    private Deque<Edge> mst;     // edges in the MST : Mininum Spanning Tree
    private boolean[] marked;    // marked[v] = true if v on tree
    Comparator<Edge> comparator = new MinPQ();
    ...
    public LazyPrimMST(EdgeWeightedGraph G) {
        ...
        pq = new PriorityQueue<Edge>(10, comparator);
...
/*    private boolean check(EdgeWeightedGraph G) {
    ...
    public static void main(String[] args) throws FileNotFoundException {
    	File in = new File("C:\\workspace_desenv_java8\\util\\br.com.bicam.util\\src\\input\\input_EdgeWeightGraph");
        ...
        System.err.format("%.5f\n", mst.weight());
    }

}

class MinPQ implements Comparator<Edge>
{
    @Override
